...
const Sidebar = ({ userRole }) => {
  ...
  return (
    <div>
      ...
      <div className="md:hidden bg-green-500 p-4 text-white flex justify-between items-center">
        <h1 className="text-xl font-bold">LendMaster</h1>
      ...
      {/* Sidebar */}
      <div
        className={`bg-gray-500 text-white w-64 min-h-screen md:static md:block fixed top-0 ${
          isOpen ? 'left-0' : '-left-64'
        } transition-all duration-300 ease-in-out z-50`}
      >
        <div className="flex items-center justify-center h-16 bg-gray-500 shadow-md">
          <h1 className="text-2xl font-bold">LendMaster</h1>
        </div>
